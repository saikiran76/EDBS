// This import is needed for browser compatibility
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import polyfill from "../packages/excalidraw/polyfill";

import { brainstormingAtom } from "../src/atoms/brainstormingAtom";
...
import { BrainstormingButton } from "../src/components/BrainstormingButton";
import { BrainstormingPanel } from "../src/components/BrainstormingPanel";
...
const ExcalidrawWrapper = () => {
  ...
  const [brainstormState] = useAtom(brainstormingAtom);
  ...
  return (
    <>
      <BrainstormingButton />
      {excalidrawAPI && <BrainstormingPanel excalidrawAPI={excalidrawAPI} />}
      <div
        style={{ height: "100%" }}
            ...
            return (
              <div className="top-right-ui">
                ...
                {excalidrawAPI && (
                  <>
                    <BrainstormingButton />
                    {brainstormState?.isOpen && (
                      <BrainstormingPanel excalidrawAPI={excalidrawAPI} />
                    )}
                  </>
                )}
              </div>
